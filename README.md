...
Sou **Alisson Alves Rodrigues**, estudante de **Análise e Desenvolvimento de Sistemas** e profissional em **transição de carreira para TI**.

Minha experiência anterior na área de alimentação me trouxe **disciplina, responsabilidade e resiliência** — habilidades que aplico hoje no aprendizado em tecnologia.

Atualmente estou focado em **Banco de Dados e SQL**, construindo uma base sólida para conquistar minha **primeira oportunidade em TI**.
...
- 📊 Modelagem de Dados
- 🔁 Projetos práticos e evolução diária
- 🚀 Objetivo: **Primeira vaga em TI (Suporte / Dados / Júnior)**

---

## 📊 Evolução real no GitHub
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Banco_de_Dados-0D1117?style=for-the-badge&logo=mysql&logoColor=white"/>
...
- [x] Iniciar transição de carreira para TI
- [x] Estruturar perfil profissional no GitHub
- [ ] Concluir Database Experience (DIO)
- [ ] Criar projeto SQL autoral
- [ ] Publicar portfólio técnico
